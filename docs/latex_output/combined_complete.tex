...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{PATH_TO_DASHBOARD_ESTUDIANTE_SCREENSHOT}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{PATH_TO_GESTION_TFG_ESTUDIANTE_SCREENSHOT}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{PATH_TO_SISTEMA_NOTIFICACIONES_SCREENSHOT}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{PATH_TO_DASHBOARD_PROFESOR_SCREENSHOT}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{PATH_TO_SISTEMA_EVALUACION_SCREENSHOT}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{PATH_TO_GESTION_TRIBUNALES_SCREENSHOT}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{PATH_TO_CALENDARIO_DEFENSAS_SCREENSHOT}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{PATH_TO_PANEL_ADMINISTRACION_SCREENSHOT}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{PATH_TO_GESTION_USUARIOS_SCREENSHOT}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{PATH_TO_SISTEMA_REPORTES_SCREENSHOT}
...
\subsubsection{Diseño Responsive y Adaptabilidad}\label{diseno-responsive-y-adaptabilidad}

Todas las interfaces implementadas siguen principios de diseño responsive que garantizan una experiencia óptima en dispositivos de diferentes tamaños. La adaptabilidad del sistema se demuestra en la transición fluida entre las versiones de escritorio y móvil, como se ilustra en la Figura~\ref{fig:responsive-design}.

\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{PATH_TO_RESPONSIVE_DESIGN_SCREENSHOT}
\caption{Comparativa del diseño responsive entre versiones desktop, tablet y móvil}
\label{fig:responsive-design}
\end{figure}

La implementación responsive utiliza breakpoints estratégicos que reorganizan el contenido de manera inteligente, colapsando navegaciones en menús hamburguesa, adaptando tablas complejas a formatos de cards en móviles y optimizando formularios para interacción táctil. El sistema mantiene la funcionalidad completa independientemente del dispositivo utilizado.
